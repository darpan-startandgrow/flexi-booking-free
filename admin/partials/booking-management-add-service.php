    ...
    <div class="wrap">
        <form role="form" method="post" enctype="multipart/form-data" class="service_page_form">
            <div class="tab" id="serviceTabs">
                ...
                <button type="button" class="tablinks" disabled title="<?php esc_attr_e( 'Saleswitch — Pro Feature', 'service-booking' ); ?>"><?php esc_html_e( 'Saleswitch', 'service-booking' ); ?> <span class="sg-pro-badge"><?php esc_html_e( 'PRO', 'service-booking' ); ?></span></button>
